...
first.deposit(100).deposit(200).deposit(300).withdraw(400).yield_interest().display_account_info()
second.deposit(1000).deposit(1000).withdraw(600).withdraw(600).withdraw(600).withdraw(600).yield_interest().display_account_info()